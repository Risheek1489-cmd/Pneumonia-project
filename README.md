...
An AI model that detects pneumonia from chest X-ray images. Built by retraining ResNet-18 on a chest X-ray dataset using an NVIDIA Jetson Orin Nano. Given an X-ray image, the model classifies it as NORMAL or PNEUMONIA along with a confidence score.
 # The Algorithm
